                ...
                <div class="col-12 col-lg-5 col-xl-3 border-right">
                    ...
                    <div class="chat_users">
                        ...
                        @if($msg_user_list->sender_id == auth()->user()->id || $msg_user_list->reciver_id == auth()->user()->id)
							<a href="{{route('student.message.all_message', ['id' => $msg_user_list->id])}}" class="list-group-item list-group-item-action">
                                <?php
                    ...
                    <div class="chat_body">
                        ...
                        <div class="flex-grow-0 py-3 px-4 border-top">
                            <div class="chat_write_box">
                                <form action="{{ route('student.message.chat_save') }}" method="post">
                                @csrf
    ...
    $(document).ready(function() {
        $('#search').on('keyup', function() {
            ...
            if (query.trim() === '') {
                ...
                $.ajax({
                    url: "{{ route('student.message.all_message', ['id' => $msg_user_details->thread_id]) }}",
                    type: "GET",
                    data: { query: query },
