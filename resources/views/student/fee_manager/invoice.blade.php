                ...
                <tr>
                  ...
                  <td>
                    <div class="dAdmin_info_name min-w-100px">
                      <p><span>{{ $invoice_details['title'] }}</span></p>
                      @php
                  ...
                  <td>
                        {{ school_currency($invoice_details['amount']) }}
                  </td>
                  <td>
                    <div class="dAdmin_info_name min-w-100px">
          ...
          <div class="salary_table">
            <div class="table-responsive">
              <table class="table eTable eTable-2">
                <tbody>
                  @if(!empty($invoice_details['discounted_price']))
                  <tr>
                    <td>
                      <div class="dAdmin_info_name">
                        <p>{{ get_phrase('Discount') }}</p>
                      </div>
                    </td>
                    <td>
                      <div class="dAdmin_info_name">
                        <p>{{ school_currency($invoice_details['discounted_price']) }}</p>
                      </div>
                    </td>
                  </tr>
                  @endif
