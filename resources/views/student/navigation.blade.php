...
<body>
	...
	<div class="sidebar">
      ...
      <li class="nav-links-li {{ request()->is('student/appraisal-list*') || request()->is('student/start-appraisal/*') ? 'showMenu':'' }}">
        <div class="iocn-link">
            <a class="{{ (request()->is('student/appraisal-list*') || request()->is('student/start-appraisal/*')) ? 'active' : '' }}" href="{{ route('student.appraisal.appraisalList') }}">
