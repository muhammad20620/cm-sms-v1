                    ...
                    <div class="export-btn-area">
                        <div class="export-btn-area">
                            <a href="javascript:;" class="export_btn"
                                onclick="rightModal('{{ route('superadmin.create.package') }}', 'Create package')"><i
                                    class="bi bi-plus"></i>{{ get_phrase('Add Package') }}</a>
                        </div>
                    </div>
                </div>
            </div>
                ...
                <ul class="nav nav-tabs eNav-Tabs-custom pt-2" id="myTab" role="tablist">
                    ...
                    <li class="nav-item" role="presentation">
                        <button class="nav-link active" id="approve-tab" data-bs-toggle="tab" data-bs-target="#approvetable"
                            ...
                            {{ get_phrase('Active ') }}<p class="badge bg-success  ms-1">{{ count($active_packages) }}</p>
                            <span></span>
                        </button>
                    </li>
                    ...
                    <li class="nav-item" role="presentation">
                        <button class="nav-link" id="decline-tab" data-bs-toggle="tab" data-bs-target="#declinetable"
                            ...
                            {{ get_phrase('Archive ') }}<p class="badge bg-danger ">{{ count($archive_packages) }}</p>
                            <span></span>
                        </button>
                    </li>
                                    ...
                                    <ul class="dropdown-menu dropdown-menu-end eDropdown-menu-2">
                                        <li>
                                            <a class="dropdown-item" id="pdf" href="javascript:;"
                                                onclick="activeExport()">{{ get_phrase('PDF') }}</a>
                                        </li>
                                        <li>
                                            <a class="dropdown-item" id="print" href="javascript:;"
                                                onclick="printableDiv('active_package_list')">{{ get_phrase('Print') }}</a>
                                        </li>
                                    </ul>
                                </div>
                            @endif
                                                    ...
                                                    <ul
                                                        ...
                                                        <li>
                                                            <a class="dropdown-item" href="javascript:;"
                                                                onclick="rightModal('{{ route('superadmin.edit.package', ['id' => $active_package->id]) }}', 'Edit Active Package')">{{ get_phrase('Edit') }}</a>
                                                        </li>
                            ...
                            @if (count($archive_packages) > 0)
                                <div class="position-relative">
                                    ...
                                    <ul class="dropdown-menu dropdown-menu-end eDropdown-menu-2">
                                        <li>
                                            <a class="dropdown-item" id="pdf" href="javascript:;"
                                                onclick="archiveExport()">{{ get_phrase('PDF') }}</a>
                                        </li>
                                        <li>
                                            <a class="dropdown-item" id="print" href="javascript:;"
                                                onclick="printableDiv('active_package_list')">{{ get_phrase('Print') }}</a>
                                            ...
                                            <td class="text-start">
                                                <div class="adminTable-action">
                                                    ...
                                                    <ul
                                                        ...
                                                        <li>
                                                            <a class="dropdown-item" href="javascript:;"
                                                                onclick="rightModal('{{ route('superadmin.edit.package', ['id' => $archive_package->id]) }}', 'Edit Archive Package')">{{ get_phrase('Edit') }}</a>
                                                        </li>
                                                        <li>
                                                            <a class="dropdown-item" href="javascript:;"
                                                                onclick="confirmModal('{{ route('superadmin.package.delete', ['id' => $archive_package->id]) }}', 'undefined');">{{ get_phrase('Delete') }}</a>
                                                        </li>
                                                    </ul>
                                                </div>
                                            </td>
