        ...
        <div class="container-xl">
            <div class="row align-items-center">
                ...
                <div class="col-lg-7 col-md-6 menu-items">
                    ...
                    <a class="small-device-show" href="#"><img src="{{ asset('frontend/assets/image/logo.png') }}"
                            alt="logo"></a>
                    ...
                    <div class="header-btn">
                        ...
                        @else
                            ...
                            <a class="signUp-btn" href="#" data-bs-toggle="modal"
                                data-bs-target="#staticBackdrop">{{ get_phrase('Register') }}</a>
                        @endif
                ...
                <div class="modal-content">
                    <div class="modal-header">
                        <h1 class="modal-title fs-5 text-center" id="staticBackdropLabel">
                            {{ get_phrase('School Register Form') }}</h1>
                                ...
                                <div class="col-lg-6">
                                        ...
                                        <div class="reg-form-group">
                                            ...
                                            <div class="single-form">
                                                ...
                                                <select class="form-select" id="blood_group" name="blood_group" required>
                                                    <option value="">{{ get_phrase('Select a blood group') }}
                                                    </option>
                                    ...
                                    @if (get_settings('recaptcha_switch_value') == 'Yes')
                                        <button class="g-recaptcha m-submit-btn"
                                            ...
                                            type="submit">{{ get_phrase('Submit') }}</button>
                                    @else
        ...
        <div class="container">
            ...
            @if (count($frontendFeatures) > 7)
                <div class="see-all-btn">
                    <a class="see-btn" id="see-btn">{{ get_phrase('See all') }} <i
        ...
        <div class="container-xl">
            ...
            <div class="row">
                @foreach ($packages as $package)
                    ...
                    @endif
                    <div class="col-lg-3 col-md-6 col-sm-6 mb-3 d-flex">
                        <div class="pricing-table h-100 w-100 d-flex flex-column d-flex flex-column justify-content-between">
                            ...
                            @elseif(Auth::check() && auth()->user()->role_id == 2)
                                ...
                                @if ($status != 1)
                                    <a href="{{ route('admin.subscription.payment', ['package_id' => $package->id]) }}"
                                        class="subscribe-btn">{{ get_phrase('Subscribe') }}</a>
                                @else
                                    <a href="javascript:;" class="subscribe-btn"
                                        onclick="subscription_warning('{{ auth()->user()->role_id }}')">{{ get_phrase('Subscribe') }}</a>
                                @endif
                            ...
                            @foreach ($faqs as $faq)
                                <div class="accordion-item">
                                    <h2 class="accordion-header" id="heading{{ $loop->index + 1 }}">
                                        <button class="accordion-button collapsed round-bg" type="button"
                                            data-bs-toggle="collapse" data-bs-target="#collapse{{ $loop->index + 1 }}"
                                            aria-expanded="false"
                                            aria-controls="collapse{{ $loop->index + 1 }}">{{ $faq->title }}</button>
                                    </h2>
                ...
                <div class="col-lg-12">
                    <div class="lan-contact">
                        <div class="contact-left text-center">
                            ...
                            <a class="contact-us-btn" href="mailto:{{ get_settings('contact_email') }}"><i
                                    class="fa-solid fa-envelope"></i> {{ get_phrase('Contact Us') }}</a>
                        </div>
                    ...
                    <div class="col-lg-4 col-md-6 col-sm-12 mb-5">
                        <div class="contacts footer-items">
                            ...
                            <ul class="ad-contacts">
                                ...
                                <li><a href="mailto:{{ get_settings('contact_email') }}"><i
                                            class="fa-solid fa-envelope"></i>{{ get_settings('contact_email') }}</a></li>
                    ...
                    <div class="col-lg-4 col-md-6 col-sm-12 mb-5">
                        <div class="addons footer-items">
                            ...
                            <ul class="footer-social">
                                <li><a href="{{ get_settings('facebook_link') }}" title="Facebook" target="_blank"><i
                                            class="fa-brands fa-facebook-f"></i></a></li>
                                <li><a href="{{ get_settings('twitter_link') }}" title="Twitter" target="_blank"><i
                                            class="fa-brands fa-twitter"></i></a></li>
                                <li><a href="{{ get_settings('linkedin_link') }}" title="Linkedin" target="_blank"><i
                                            class="fa-brands fa-linkedin-in"></i></a></li>
                                <li><a href="{{ get_settings('instagram_link') }}" title="Instagram" target="_blank"><i
