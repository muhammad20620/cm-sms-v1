        ...
        <div class="container-xl">
            <div class="row align-items-center">
                <div class="col-lg-2 col-md-6 col-sm-6 col-5">
                    <!-- Logo  -->
                    <div class="logo">
                        <a href="#"><img src="{{ asset('assets/uploads/logo/logoUpdated.svg') }}" alt="Logo"></a>
                    </div>
                </div>
            ...
            <div class="row">
                <div class="col-lg-6">
                    ...
                    <div class="bannar-content">
                        ...
                        <ul class="d-flex flex-column flex-wrap gap-3 list-unstyled text-start pt-2" {{-- style="list-style:none; padding-left:0; margin-bottom:0;" --}}>
        ...
        <div class="container-xl">
            <div class="row">
                <div class="col-lg-3 col-sm-6 mb-3">
                    <h4>{{ get_phrase('Save time') }}</h4>
                    <p>{{ get_phrase('Automate routine academic and admin work.') }}</p>
                </div>
                <div class="col-lg-3 col-sm-6 mb-3">
                    <h4>{{ get_phrase('Grow confidently') }}</h4>
                    <p>{{ get_phrase('Multi‑school, multi‑role, multi‑language SaaS.') }}</p>
                </div>
                <div class="col-lg-3 col-sm-6 mb-3">
                    <h4>{{ get_phrase('Get paid faster') }}</h4>
                    <p>{{ get_phrase('Integrated online and offline fee collection.') }}</p>
                </div>
                <div class="col-lg-3 col-sm-6 mb-3">
                    <h4>{{ get_phrase('Stay in sync') }}</h4>
                    <p>{{ get_phrase('Real‑time dashboards, reports, and notifications.') }}</p>
                </div>
            </div>
        </div>
    </section>
    ...
    <section class="section-padding">
        <div class="container-xl">
            <ul class="d-flex flex-wrap justify-content-center gap-3" style="list-style:none; padding-left:0;">
                <li>{{ get_phrase('Role‑based access') }}</li>
                <li>•</li>
                <li>{{ get_phrase('Data privacy first') }}</li>
                <li>•</li>
                <li>{{ get_phrase('Reliable performance') }}</li>
                <li>•</li>
                <li>{{ get_phrase('Multilingual') }}</li>
            </ul>
        </div>
    </section>
                ...
                <div class="col-lg-12">
                    <div class="lan-contact">
                        <div class="contact-left text-center">
                            ...
                            <a class="contact-us-btn mt-4" href="{{ route('contact') }}"><i
                    ...
                    <div class="col-lg-4 col-md-6 col-sm-12 mb-5">
                        <div class="footer-items">
                            <div class="footer-logo">
                                <a href="#"><img src="{{ asset('assets/uploads/logo/LogoLight.svg') }}"
                                        alt="image"></a>
                            </div>
