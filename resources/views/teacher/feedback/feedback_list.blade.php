        ...
        <div class="col-12">
            ...
            >
                ...
                <div class="export-btn-area">
                    <a href="javascript:;" class="export_btn" onclick="rightModal('{{ route('teacher.feedback.create_feedback') }}', '{{ get_phrase('Create Feedback') }}')"><i class="bi bi-plus"></i>{{ get_phrase('Add New Feedback') }}</a>
                </div>
            </div>
        </div>
    </div>
          ...
          <div class="eCard-body">
            ...
            <div class="eCard-AdminBtn d-flex flex-wrap justify-content-between align-items-center">
              ...
              <div class="adminTable-action">
                ...
                >
                  <li>
                    <a class="dropdown-item" href="javascript:;" onclick="rightModal('{{ route('teacher.feedback.edit_feedback', ['id' => $feedback->id]) }}', '{{ get_phrase('Edit feedback') }}')">{{ get_phrase('Edit') }}</a>
                  </li>
                  <li>
                    <a class="dropdown-item" href="javascript:;" onclick="confirmModal('{{ route('teacher.feedback.delete_feedback', ['id' => $feedback->id]) }}', 'undefined');">{{ get_phrase('Delete') }}</a>
                  </li>
                </ul>
              </div>
            </div>
