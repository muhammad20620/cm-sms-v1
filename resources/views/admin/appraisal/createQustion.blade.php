...
<form method="POST" enctype="multipart/form-data" class="d-block ajaxForm" action="{{ route('admin.appraisal.storeQustion') }}">
    @csrf 
    <div class="fpb-7">
    ...
    <div class="fpb-7">
        <label for="qustion" class="eForm-label">{{ get_phrase('Qustion') }}</label>
        <div class="new_div">
            <div class="row">
                <div class="col-sm-9" id="inputContainer">
                    <input type="text" name="question[]" class="eForm-control form-control" placeholder="{{get_phrase('Write Question')}}">
                </div>
