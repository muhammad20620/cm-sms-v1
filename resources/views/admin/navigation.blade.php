...
<body>
    ...
    <div class="sidebar">
      ...
      <ul class="nav-links">
        ...
        @if(empty($user->menu_permission) || in_array('admin.appraisal.appraisalQustions', $menu_permission) || in_array('admin.appraisal.studentFeedback', $menu_permission))
        <li class="nav-links-li {{ request()->is('admin/appraisal-qustion*') || request()->is('admin/appraisal-student-feedback*') ? 'showMenu':'' }}">
            <div class="iocn-link">
                <a href="#">
            ...
            <ul class="sub-menu">
              ...
              <li><a class="{{ (request()->is('admin/appraisal-qustion')) ? 'active' : '' }}" href="{{ route('admin.appraisal.appraisalQustions') }}"><span>
                {{ get_phrase('Appraisal Qustion') }}
              </span></a></li>
              @endif
              @if(empty($user->menu_permission) || in_array('admin.appraisal.studentFeedback', $menu_permission))
              <li><a class="{{ (request()->is('admin/appraisal-student-feedback')) ? 'active' : '' }}" href="{{ route('admin.appraisal.studentFeedback') }}"><span>
