    ...
    <div class="sidebar">
        <div class="logo-details mt-4 mb-3">
            <div class="img_wrapper">
                <img height="40px" class="" src="{{ get_logo_url('white_logo') }}" alt="" />
            </div>
        ...
        <ul class="nav-links">
            ...
            @if (empty($user->menu_permission) ||
                ...
                <li
                    ...
                    <ul class="sub-menu">
                        ...
                        @endif
                        @if (\Illuminate\Support\Facades\Route::has('admin.student_withdrawals'))
                            <li>
                                <a class="{{ request()->is('admin/student-withdrawals*') ? 'active' : '' }}"
                                    href="{{ route('admin.student_withdrawals') }}">
                                    <span>{{ get_phrase('Student Withdrawals (SLC)') }}</span>
                                </a>
                            </li>
                        @endif
            ...
            @if (empty($user->menu_permission) || in_array('admin.offline_admission.single', $menu_permission))
                ...
                <li
                    ...
                    <ul class="sub-menu">
                        <li>
                            <a class="{{ request()->is('admin/settings/student-number-patterns*') ? 'active' : '' }}"
                                href="{{ route('admin.student_number_patterns') }}">
                                <span>
                                    {{ get_phrase('Student Number Patterns') }}
                                </span>
                            </a>
                        </li>
                        <li>
                            @if (\Illuminate\Support\Facades\Route::has('admin.vehicle.list'))
                                <a class="{{ request()->is('admin/vehicle/list') ? 'active' : '' }}"
                                    href="{{ route('admin.vehicle.list') }}"><span>{{ get_phrase('Vehicle') }}</span></a>
                            @endif
                        </li>
                        <li>
                            @if (\Illuminate\Support\Facades\Route::has('admin.assign.student.list'))
            ...
            @if (empty($user->menu_permission) ||
                ...
                <li
                    ...
                    <ul class="sub-menu">
                        ...
                        @endif
                        @if (\Illuminate\Support\Facades\Route::has('admin.fees.generator'))
                            <li>
                                <a class="{{ request()->is('admin/fees/generator*') ? 'active' : '' }}"
                                    href="{{ route('admin.fees.generator') }}">
                                    <span>{{ get_phrase('Fee Generator') }}</span>
                                </a>
                            </li>
                        @endif
                        @if (\Illuminate\Support\Facades\Route::has('admin.fees.class_fees'))
                            <li>
                                <a class="{{ request()->is('admin/fees/class-fees*') ? 'active' : '' }}"
                                    href="{{ route('admin.fees.class_fees') }}">
                                    <span>{{ get_phrase('Class Fees') }}</span>
                                </a>
                            </li>
                        @endif
                        @if (\Illuminate\Support\Facades\Route::has('admin.fees.concessions'))
                            <li>
                                <a class="{{ request()->is('admin/fees/concessions*') ? 'active' : '' }}"
                                    href="{{ route('admin.fees.concessions') }}">
                                    <span>{{ get_phrase('Scholarships / Discounts') }}</span>
                                </a>
                            </li>
                        @endif
                        @if (\Illuminate\Support\Facades\Route::has('admin.fees.sibling_discounts'))
                            <li>
                                <a class="{{ request()->is('admin/fees/sibling-discounts*') ? 'active' : '' }}"
                                    href="{{ route('admin.fees.sibling_discounts') }}">
                                    <span>{{ get_phrase('Sibling Discounts') }}</span>
                                </a>
                            </li>
                        @endif
            ...
            @if (empty($user->menu_permission) ||
                    ...
                    in_array('admin.applications', $menu_permission))
                <li
                    class="nav-links-li {{ request()->is('admin/book*') || request()->is('admin/book_issue*') || request()->is('admin/noticeboard*') || request()->is('admin/subscription') || request()->is('admin/events/list*') || request()->is('admin/feedback-list*') || request()->is('admin/applications*') ? 'showMenu' : '' }}">
                    <div class="iocn-link">
                        <a href="#">
                            <div class="sidebar_icon">
                    ...
                    <ul class="sub-menu">
                        ...
                        @endif
                        @if (\Illuminate\Support\Facades\Route::has('admin.applications') && (empty($user->menu_permission) || in_array('admin.applications', $menu_permission)))
                            <li>
                                <a class="{{ request()->is('admin/applications*') ? 'active' : '' }}"
                                    href="{{ route('admin.applications') }}"><span>{{ get_phrase('Applications') }}
                                    </span></a>
                            </li>
                        @endif
                    </ul>
            ...
            @if (empty($user->menu_permission) ||
                    in_array('admin.appraisal.appraisalQustions', $menu_permission) ||
                    in_array('admin.appraisal.studentFeedback', $menu_permission))
                <li
                    class="nav-links-li {{ request()->is('admin/appraisal-qustion*') || request()->is('admin/appraisal-student-feedback*') ? 'showMenu' : '' }}">
                    <div class="iocn-link">
                        <a href="#">
                            <div class="sidebar_icon mt-4">
                                <?xml version="1.0" encoding="utf-8"?><svg version="1.1" id="Layer_1"
                                    xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink"
                                    x="0px" y="0px" viewBox="0 0 106.86 122.88"
                    ...
                    <ul class="sub-menu">
                        @if (empty($user->menu_permission) || in_array('admin.appraisal.appraisalQustions', $menu_permission))
                            <li><a class="{{ request()->is('admin/appraisal-qustion') ? 'active' : '' }}"
                                    href="{{ route('admin.appraisal.appraisalQustions') }}"><span>
                                        {{ get_phrase('Appraisal Qustion') }}
                                    </span></a></li>
                        @endif
        ...
        <div class="home-content">
                        ...
                        <div class="header_notification d-flex align-items-center">
                            <div class="notification_icon">
                                ...
                                @if (!empty($school_data->school_logo))
                                    <img class=""
                                        src="{{ get_upload_url('assets/uploads/school_logo',DB::table('schools')->where('id', auth()->user()->school_id)->value('school_logo')) }}"
            ...
            <div class="main_content">
                ...
                <div class="copyright-text">
                    ...
                    <p>{{ $active_session }} &copy; <span><a class="text-info footer-color" target="_blank"
