...
<div class="row">
    <div class="col-12">
    	<div class="eSection-wrap-2">
            <form method="GET" enctype="multipart/form-data" class="d-block ajaxForm" action="{{ route('admin.offline_payment_pending') }}">
            	<div class="row">
				        ...
				        <div class="col-xl-2 ">
		                    <div class="position-relative">
		                      ...
		                      <ul class="dropdown-menu dropdown-menu-end eDropdown-menu-2">
		                        ...
		                        <li>
		                            <a class="dropdown-item" id="download-button" href="{{ route('admin.fee_manager.export', ['date_from' => $date_from, 'date_to' => $date_to, 'selected_class' => $sel_class, 'selected_status' => $sel_status]) }}">{{ get_phrase('CSV') }}</a>
		                        </li>
		                        <li>
            ...
            <div class="invoice_content" id="student_fee_manager">
	            @include('admin.student_fee_manager.list_pending')
	        </div>
		</div>
	</div>
</div>
