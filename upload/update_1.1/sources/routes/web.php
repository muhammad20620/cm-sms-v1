...
Route::controller(SuperAdminController::class)->middleware('auth','superAdmin')->group(function () {
    ...
    Route::get('superadmin/school/delete/{id}', 'schoolDelete')->name('superadmin.school.delete');
    ...
    Route::get('superadmin/school/pending', 'pendingSchool')->name('superadmin.school.pending');
    Route::get('superadmin/school/approve/{id}', 'approveSchool')->name('superadmin.school.approve');
    ...
    Route::get('superadmin/subscription/approve', 'subscriptionApprovePayment')->name('superadmin.subscription.approve');
...
Route::controller(AdminController::class)->middleware('admin','auth')->group(function () {
    ...
    Route::get('admin/parent/create_modal', 'createParentModal')->name('admin.parent.open_modal');
...
Route::controller(ParentController::class)->middleware('parent','auth')->group(function () {
    ...
    Route::get('parent/attendance/filter', 'parentdailyAttendanceFilter')->name('parent.attendance_filter');
...
Route::controller(StudentController::class)->middleware('student','auth')->group(function () {
    ...
    Route::get('student/attendance/filter', 'dailyAttendanceFilter')->name('student.daily_attendance.filter');
