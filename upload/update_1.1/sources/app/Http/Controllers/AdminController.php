...
class AdminController extends Controller
{
    ...
    public function adminList()
    {
        ...
        return view('admin.admin.admin_list', ['admins' => $admins]);
    }
    ...
    public function teacherList()
    {
        ...
        return view('admin.teacher.teacher_list', ['teachers' => $teachers]);
    }
    ...
    {
        $accountants = User::get()->where('role_id', 4)->where('school_id', auth()->user()->school_id);
        return view('admin.accountant.accountant_list', ['accountants' => $accountants]);
    }
    ...
    {
        $librarians = User::get()->where('role_id', 5)->where('school_id', auth()->user()->school_id);
        return view('admin.librarian.librarian_list', ['librarians' => $librarians]);
    }
    ...
    {
        $parents = User::get()->where('role_id', 6)->where('school_id', auth()->user()->school_id);
        return view('admin.parent.parent_list', ['parents' => $parents]);
    }

    public function createParentModal()
    {
    ...
    {
        $user = User::find($id);
        return view('admin.parent.edit_parent', ['user' => $user]);
    }
    ...
    {
        $students = User::where('role_id', 7)->where('school_id', auth()->user()->school_id)->paginate(10);
    ...
    {
        $classes = Classes::where('school_id', auth()->user()->school_id)->get();
        return view('admin.attendance.daily_attendance', ['classes' => $classes]);
    }
    ...
    public function dailyAttendanceFilter(Request $request)
    {
        ...
        $classes = Classes::where('school_id', auth()->user()->school_id)->get();
        return view('admin.attendance.attendance_list', ['page_data' => $page_data, 'classes' => $classes]);
    }
    ...
    public function subjectList(Request $request)
    {
        ...
        return view('admin.subject.subject_list', ['subjects' => $subjects, 'classes' => $classes, 'class_id' => $class_id]);
    }
    ...
    {
        $departments = Department::get()->where('school_id', auth()->user()->school_id);
        return view('admin.department.department_list', ['departments' => $departments]);
    }
    ...
    {
        $class_rooms = ClassRoom::get()->where('school_id', auth()->user()->school_id);
        return view('admin.class_room.class_room_list', ['class_rooms' => $class_rooms]);
    }
    ...
    public function classList()
    {
        ...
        return view('admin.class.class_list', ['class_lists' => $class_lists]);
    }
    ...
    {
        $expense_categories = ExpenseCategory::where('school_id', auth()->user()->school_id)->get();
        return view('admin.expense_category.expense_category_list', ['expense_categories' => $expense_categories]);
    }
    ...
    public function subscription(Request $request)
    {
        ...
        $subscription_details = Subscription::where(['school_id' => auth()->user()->school_id, 'status' => '1']);
    ...
    {
        $events = FrontendEvent::get()->where('school_id', auth()->user()->school_id);
