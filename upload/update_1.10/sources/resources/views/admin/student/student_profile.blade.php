            ...
            >
              ...
              >
                <form action="{{route('admin.user_password')}}" method="post">
                    @CSRF
                    <div class="fpb-7">
                        <input type="text" class="form-control eForm-control" name="password" id="password{{ $student_details['user_id'] }}">
                    ...
                    <div class="generatePass d-flex">
                        <div class="pt-2">
                            <button type="button"
                                ...
                                aria-expanded="false" onclick="generatePassword('{{ $student_details['user_id']  }}')">Generate Password</button>
                        </div>
                        <div class="ms-3 pt-2">
