...
<div class="table-responsive department_list display-none-view" id="department_list">
  <h4 class="" style="font-size: 16px; font-weight: 600; line-height: 26px; color: #181c32; margin-left:7%; margin-bottom:15px; margin-top:17px;"><?php echo e(get_phrase('Department List')); ?></h4> 
    <table class="table eTable">
        <thead>
            <tr>
                <th>#</th>
...
<?php echo $__env->make('admin.navigation', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /Applications/XAMPP/xamppfiles/htdocs/Ekattor8 School Management System/eq2/resources/views/admin/department/department_list.blade.php ENDPATH**/ ?>