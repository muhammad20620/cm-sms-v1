...
<div class="export position-relative">
  ...
  <ul class="dropdown-menu dropdown-menu-end eDropdown-menu-2">
    ...
    <li>
        <a class="dropdown-item" id="print" href="javascript:;" onclick="ePrintDiv('routine_report')"><?php echo e(get_phrase('Print')); ?></a>
    </li>
  </ul>
</div>
...
<script type="text/javascript">
  ...
  "use strict";
    ...
    function generatePDF() {
        ...
        var opt = {
          margin:       1,
          filename:     'routine-<?php echo e('class_id-'.$class_id.'-'.'section-'.$section_id); ?>.pdf',
...
</script><?php /**PATH /Applications/XAMPP/xamppfiles/htdocs/Ekattor8 School Management System/eq2/resources/views/student/routine/routine_list.blade.php ENDPATH**/ ?>