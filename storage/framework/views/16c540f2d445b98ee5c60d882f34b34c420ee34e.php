...
<div class="export position-relative">
  ...
  <ul class="dropdown-menu dropdown-menu-end eDropdown-menu-2">
    ...
    <li>
        <a class="dropdown-item"  href="<?php echo e(route('admin.marks.list_pdf', ['section_id' => $page_data['section_id'], 'class_id' => $page_data['class_id'], 'session_id' => $page_data['session_id'], 'exam_category_id' => $page_data['exam_category_id'], 'subject_id' => $page_data['subject_id'] ])); ?>" ><?php echo e(get_phrase('PDF')); ?></a>
    </li>
    <li>
        <a class="dropdown-item" id="print" href="javascript:;" onclick="printableDiv('mark_history')"><?php echo e(get_phrase('Print')); ?></a>
    </li>
  </ul>
</div>
<?php endif; ?>
    ...
    <table class="table eTable table-bordered">
        <thead>
            <tr>
                ...
                <th scope="col"><?php echo e(get_phrase('Mark')); ?></th>
                <th scope="col"><?php echo e(get_phrase('Grade point')); ?></th>
                <th scope="col"><?php echo e(get_phrase('Comment')); ?></th>
        ...
        <tbody>
            <?php $__currentLoopData = $enroll_students; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $enroll_student): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                ...
                <tr>
                    ...
                    <td>
                        <span id="grade-for-mark-<?php echo e($enroll_student->user_id); ?>"><?php echo e(get_grade($user_marks)); ?></span> 
                    </td>
                    <td>
                        <input class="form-control eForm-control" type="text" id="comment-<?php echo e($enroll_student->user_id); ?>" name="comment" placeholder="comment" value="<?php echo e($comment); ?>" required>
                    </td>
        ...
        <tbody>
            <?php $__currentLoopData = $enroll_students; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $enroll_student): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                ...
                <tr>
                    <td><?php echo e($student_details->name); ?></td>
                    <td>
                        <span id="mark-<?php echo e($enroll_student->user_id); ?>"><?php echo e($user_marks); ?></span>
                    </td>
                    <td>
                        <span id="grade-for-mark-<?php echo e($enroll_student->user_id); ?>"><?php echo e(get_grade($user_marks)); ?></span> 
                    </td>
                    <td>
                        <span id="comment-<?php echo e($enroll_student->user_id); ?>"><?php echo e($comment); ?></span>
                    </td>
                </tr>
            <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
        </tbody>
...
<script type="text/javascript">
  ...
  function Export() {
    ...
    var opt = {
    margin:       1,
    filename:     'mark_report_<?php echo e(date("y-m-d")); ?>.pdf',
    ...
    function mark_update(student_id){
        ...
        var session_id = '<?php echo e($page_data['session_id']); ?>';
...
</script><?php /**PATH /Applications/XAMPP/xamppfiles/htdocs/Ekattor8 School Management System/eq2/resources/views/admin/marks/marks_list.blade.php ENDPATH**/ ?>