	  ...
	  <div class="eSection-packageList">
	    ...
	    <?php $__currentLoopData = $packages; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $package): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
			...
			?>
				...
				<?php if($packageStudent == 'Unlimited' && $packagesPrice < $subscriptionsPrice && $subscribeStudent == 'Unlimited'): ?>
						
				<?php else: ?>
				
				<?php if($upgradePrice > 0 && ($packagesPrice > $subscriptionsPrice && $package->interval == 'life_time' || $subscribeStudent < $packageStudent && $package['id'] != $subscription->package_id)): ?>
					<div class="col-lg-3 col-md-6">
						...
						<p class="packagePrice">
							<?php if($subscription->active == 1): ?>
							<span><?php echo e(currency($upgradePrice)); ?></span>/
							<?php echo e(currency($package->price)); ?>
						...
						<?php if($subscribeStudent == 'Unlimited' || $packageStudent == 'Unlimited' ): ?>
						<p class="total_std">Students: Unlimited</p>
						<?php else: ?>
						<p class="total_std">Upgrade Students: +<?php echo e($upgradeStudent); ?></p>
						<?php endif; ?>
							<?php
						...
						<a href="<?php echo e(route('admin.subscription.payment',['package_id'=>$package['id'] ])); ?>" class="packageSubs_btn"><?php echo e(get_phrase('Upgrade Subscribe')); ?></a>
...
<?php echo $__env->make('admin.navigation', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /Applications/XAMPP/xamppfiles/htdocs/Ekattor8 School Management System/eq2/resources/views/admin/subscription/upgrade_subscription.blade.php ENDPATH**/ ?>