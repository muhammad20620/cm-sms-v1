...
<body>
    ...
    <div class="sidebar">
      ...
      <ul class="nav-links">
        ...
        <?php if(empty($user->menu_permission) || in_array('admin.appraisal.appraisalQustions', $menu_permission) || in_array('admin.appraisal.studentFeedback', $menu_permission)): ?>
        <li class="nav-links-li <?php echo e(request()->is('admin/appraisal-qustion*') || request()->is('admin/appraisal-student-feedback*') ? 'showMenu':''); ?>">
            <div class="iocn-link">
                <a href="#">
            ...
            <ul class="sub-menu">
              <?php if(empty($user->menu_permission) || in_array('admin.appraisal.appraisalQustions', $menu_permission)): ?>
              <li><a class="<?php echo e((request()->is('admin/appraisal-qustion')) ? 'active' : ''); ?>" href="<?php echo e(route('admin.appraisal.appraisalQustions')); ?>"><span>
                <?php echo e(get_phrase('Appraisal Qustion')); ?>

              </span></a></li>
              <?php endif; ?>
              <?php if(empty($user->menu_permission) || in_array('admin.appraisal.studentFeedback', $menu_permission)): ?>
              <li><a class="<?php echo e((request()->is('admin/appraisal-student-feedback')) ? 'active' : ''); ?>" href="<?php echo e(route('admin.appraisal.studentFeedback')); ?>"><span>
                <?php echo e(get_phrase('Student Feedback')); ?>
...
<?php /**PATH /Applications/XAMPP/xamppfiles/htdocs/Ekattor8 School Management System/eq2/resources/views/admin/navigation.blade.php ENDPATH**/ ?>