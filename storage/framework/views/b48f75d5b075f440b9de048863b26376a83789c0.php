        ...
        <div class="col-sm-5">
          <div class="invoice_details text-sm-end">
            ...
            <?php if (strtolower($invoice_details['status']) == 'paid'): ?>
              <span class="eBadge ebg-soft-success"><?php echo e(get_phrase('Paid')); ?></span></p>
            <?php else: ?>
              <span class="eBadge ebg-soft-danger"><?php echo e(get_phrase('Unpaid')); ?></span></p>
            <?php endif; ?>
          </div>
        </div>
      </div>
            ...
            <table class="table eTable eTable-2 tbody-border">
              ...
              <tbody>
                <tr>
                  ...
                  <td>
                        <?php echo e(school_currency($invoice_details['amount'])); ?>
          ...
          <div class="salary_table">
            <div class="table-responsive">
              <table class="table eTable eTable-2">
                <tbody>
                  <?php if(!empty($invoice_details['discounted_price'])): ?>
                  <tr>
                    <td>
                      <div class="dAdmin_info_name">
                        <p><?php echo e(get_phrase('Discount')); ?></p>
                      </div>
                    </td>
                    <td>
                      <div class="dAdmin_info_name">
                        <p><?php echo e(school_currency($invoice_details['discounted_price'])); ?></p>
                      </div>
                    </td>
                  </tr>
                  <?php endif; ?>
...
<?php echo $__env->make('student.navigation', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /Applications/XAMPP/xamppfiles/htdocs/Ekattor8 School Management System/eq2/resources/views/student/fee_manager/invoice.blade.php ENDPATH**/ ?>