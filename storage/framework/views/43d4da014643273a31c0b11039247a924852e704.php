            ...
            >
                <div class="d-flex flex-column">
                    ...
                    <ul class="d-flex align-items-center eBreadcrumb-2">
                        ...
                        <li><a href="#"><?php echo e(get_phrase('Issued Book')); ?></a></li>
                    </ul>
                </div>
            </div>
        </div>
...
<div class="row">
    <div class="col-12">
        <div class="eSection-wrap pb-2">
            ...
            <form method="GET" enctype="multipart/form-data" class="d-block ajaxForm" action="<?php echo e(route('student.book.issued_list')); ?>">
                    <div class="row">
                        ...
                        <div class="col-xl-4">
                            <div class="export position-relative">
                              ...
                              <ul class="dropdown-menu dropdown-menu-end eDropdown-menu-2">
                                ...
                                <li>
                                    <a class="dropdown-item" id="print" href="javascript:;" onclick="ePrintDiv('issued_book_report')"><?php echo e(get_phrase('Print')); ?></a>
                                </li>
                              </ul>
                            </div>
                        </div>
            ...
            <div class="book_issue_content">
                <?php echo $__env->make('student.book.issued_list', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
            </div>
        </div>
    </div>
</div>
...
<?php echo $__env->make('student.navigation', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /Applications/XAMPP/xamppfiles/htdocs/Ekattor8 School Management System/eq2/resources/views/student/book/book_issue.blade.php ENDPATH**/ ?>