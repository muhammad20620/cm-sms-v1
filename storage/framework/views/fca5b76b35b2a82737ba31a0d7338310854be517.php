      ...
      <div class="col-12">
        ...
        >
          ...
          <div class="export-btn-area">
            <a href="javascript:;" class="export_btn" onclick="rightModal('<?php echo e(route('admin.routine.open_modal')); ?>', '<?php echo e(get_phrase('Add class routine')); ?>')"><?php echo e(get_phrase('Add class routine')); ?></a>
          </div>
        </div>
      </div>
    </div>
...
<div class="row">
  <div class="col-12">
    <div class="eSection-wrap-2">
    	<form method="GET" class="d-block ajaxForm" action="<?php echo e(route('admin.routine.routine_list')); ?>">
        <div class="row mt-3">
            ...
            <div class="col-md-2 position-relative">
              ...
              <ul class="dropdown-menu dropdown-menu-end eDropdown-menu-2">
                ...
                <li>
                    <a class="dropdown-item" id="print" href="javascript:;" onclick="printableDiv('class_routines')"><?php echo e(get_phrase('Print')); ?></a>
                </li>
              </ul>
            </div>
      ...
      <ul class="class_routine_content pt-4" id="class_routines">
        <li class="classRoutines-item d-flex align-items-center">
          <h4 class="title"><?php echo e(get_phrase('Saturday')); ?></h4>
          <div class="classTime-items d-flex">
            ...
            <div class="classTime-item">
              ...
              <div class="d-flex">
                <h4 class="subjectName">
                  <?php if(!empty($subject->name)): ?>
                  <?php echo e($subject->name); ?>

                  <?php else: ?>
                  <?php echo e(get_phrase('Empty')); ?>
                ...
                <div class="btn-group ms-auto">
                  ...
                  <ul class="dropdown-menu dropdown-menu-end">
                    <li>
                      <a class="text-16px ps-2" href="javascript:;" onclick="rightModal('<?php echo e(route('admin.routine_edit_modal', ['id' => $perday_routine['id']])); ?>', '<?php echo e(get_phrase('Edit class routine')); ?>')"><?php echo e(get_phrase('Edit')); ?>

                      </a>
                    </li>
                    <li>
                      <a class="text-16px ps-2" href="javascript:;" onclick="confirmModal('<?php echo e(route('admin.routine.delete', ['id' => $perday_routine['id']])); ?>', 'undefined');"><?php echo e(get_phrase('Delete')); ?></a>
                    </li>
                  </ul>
                </div>
              </div>
              ...
              <ul class="classDetails">
                ...
                >
                  ...
                  <p class="info"><?php echo e($perday_routine['starting_hour'].':'.$perday_routine['starting_minute'].' - '.$perday_routine['ending_hour'].':'.$perday_routine['ending_minute']); ?></p>
                </li>
                <li
                  class="classDetails-info d-flex align-items-center"
                >
                  ...
                  <p class="info"><?php echo e($teacher->name); ?></p>
                </li>
                <li
                  class="classDetails-info d-flex align-items-center"
                >
                  ...
                  <p class="info"><?php echo e($class_room->name); ?></p>
                </li>
              </ul>
            </div>
            <?php } ?>
        ...
        <li class="classRoutines-item d-flex align-items-center">
          <h4 class="title"><?php echo e(get_phrase('Sunday')); ?></h4>
          <div class="classTime-items d-flex">
            ...
            <div class="classTime-item">
              <?php $subject = Subject::find($perday_routine['subject_id']); ?>
              <div class="d-flex">
                <h4 class="subjectName"><?php echo e($subject->name); ?></h4>
                <div class="btn-group ms-auto">
                  <button type="button" class="btn" data-bs-toggle="dropdown" aria-expanded="false">
                    <i class="bi bi-three-dots-vertical"></i>
                  </button>
        ...
        <li class="classRoutines-item d-flex align-items-center">
          <h4 class="title"><?php echo e(get_phrase('Monday')); ?></h4>
          <div class="classTime-items d-flex">
            ...
            <div class="classTime-item">
              <?php $subject = Subject::find($perday_routine['subject_id']); ?>
              <div class="d-flex">
                <h4 class="subjectName"><?php if(!empty($subject->name)): ?>
                  <?php echo e($subject->name); ?>
        ...
        <li class="classRoutines-item d-flex align-items-center">
          <h4 class="title"><?php echo e(get_phrase('Tuesday')); ?></h4>
          <div class="classTime-items d-flex">
        ...
        <li class="classRoutines-item d-flex align-items-center">
          <h4 class="title"><?php echo e(get_phrase('Wednesday')); ?></h4>
          <div class="classTime-items d-flex">
        ...
        <li class="classRoutines-item d-flex align-items-center">
          <h4 class="title"><?php echo e(get_phrase('Thursday')); ?></h4>
          <div class="classTime-items d-flex">
        ...
        <li class="classRoutines-item d-flex align-items-center">
          <h4 class="title"><?php echo e(get_phrase('Friday')); ?></h4>
          <div class="classTime-items d-flex">
...
<script type="text/javascript">
  ...
  "use strict";
    ...
    var getFilteredClassRoutine = function() {
        ...
        var section_id = $('#section_id').val();
        if(class_id != "" && section_id!= ""){
            let url = "<?php echo e(route('admin.routine.routine_list')); ?>";
            $.ajax({
                url: url,
                headers: {
...
<?php echo $__env->make('admin.navigation', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /Applications/XAMPP/xamppfiles/htdocs/Ekattor8 School Management System/eq2/resources/views/admin/routine/routine_list.blade.php ENDPATH**/ ?>