            ...
            <div class="d-flex justify-content-between align-items-center flex-wrap gr-15">
                <div class="d-flex flex-column">
                    ...
                    <ul class="d-flex align-items-center eBreadcrumb-2">
                        ...
                        <li><a href="#"><?php echo e(get_phrase('Appraisal List')); ?></a></li>
                    </ul>
                </div>
            </div>
        </div>
                            ...
                            <tr>
                                ...
                                <td>
                                    <div class="export-btn-area  min-w-200px">
                                        <a href="<?php echo e(route('student.appraisal.singleAppraisal', ['id' => $appraisal->id])); ?>" class="export_btn"><?php echo e(get_phrase('Start Appraisal')); ?></a>
                                      </div>
                                </td>
                            </tr>
...
<?php echo $__env->make('student.navigation', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /Applications/XAMPP/xamppfiles/htdocs/Ekattor8 School Management System/eq2/resources/views/student/appraisal/appraisalList.blade.php ENDPATH**/ ?>