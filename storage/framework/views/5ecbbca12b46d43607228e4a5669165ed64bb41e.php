        ...
        <div class="eSection-wrap pb-2">
            ...
            <div class="export position-relative">
              ...
              <ul class="dropdown-menu dropdown-menu-end eDropdown-menu-2">
                ...
                <li>
                    <a class="dropdown-item" id="print" href="javascript:;" onclick="ePrintDiv('grade_report')"><?php echo e(get_phrase('Print')); ?></a>
                </li>
              </ul>
            </div>
            <?php endif; ?>
        	...
        	<div class="grade_content" id="grade_report">
        		<table class="table eTable">
		            <thead>
		                <tr>
		                    <th>#</th>
		                    <th><?php echo e(get_phrase('Grade')); ?></th>
		                    <th><?php echo e(get_phrase('Grade Point')); ?></th>
		                    <th><?php echo e(get_phrase('Mark From')); ?></th>
		                    <th><?php echo e(get_phrase('Mark Upto')); ?></th>
		                </tr>
		            </thead>
		            <tbody>
		                <?php $__currentLoopData = $grades; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key => $grade): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
		                     <tr>
		                        <td><?php echo e($grades->firstItem() + $key); ?></td>
		        ...
		        <?php echo $grades->appends(request()->all())->links(); ?>
...
<?php echo $__env->make('student.navigation', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /Applications/XAMPP/xamppfiles/htdocs/Ekattor8 School Management System/eq2/resources/views/student/grade/grade_list.blade.php ENDPATH**/ ?>