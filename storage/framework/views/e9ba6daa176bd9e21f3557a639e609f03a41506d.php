<form method="POST" enctype="multipart/form-data" class="d-block ajaxForm responsive_media_query" action="<?php echo e(route('admin.attendance_take')); ?>">
    <?php echo csrf_field(); ?> 
    <div class="form-row">
        <div class="fpb-7">
  ...
  "use strict";
    ...
    function getStudentList() {
        ...
        if(date != '' && class_id != '' && section_id != ''){
            $.ajax({
                // type : 'POST',
                url : '<?php echo e(route('admin.attendance.student')); ?>',
                headers: {
...
<?php /**PATH /Applications/XAMPP/xamppfiles/htdocs/Ekattor8 School Management System/eq2/resources/views/admin/attendance/take_attendance.blade.php ENDPATH**/ ?>