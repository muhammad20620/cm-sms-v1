...
var getDailtyAttendance = function () {
  ...
  var class_id = $('#class_id').val();
  var section_id = $('#section_id').val();
  let url = "<?php echo e(route('admin.daily_attendance.filter')); ?>";
  if(class_id != "" && section_id != "" && month != "" && year != ""){
    $.ajax({
		url: url,
		headers: {
...
<?php echo $__env->make('admin.navigation', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /Applications/XAMPP/xamppfiles/htdocs/Ekattor8 School Management System/eq2/resources/views/admin/attendance/daily_attendance.blade.php ENDPATH**/ ?>