	...
	<div class="sidebar">
        ...
        <div class="iocn-link">
          <a href="<?php echo e(route('student.dashboard')); ?>">
			...
			<li class="nav-links-li <?php echo e(request()->is('student/teacher*') ? 'showMenu':''); ?>">
				<div class="iocn-link">
					<a class="<?php echo e((request()->is('student/teacher*')) ? 'active' : ''); ?>" href="<?php echo e(route('student.teacher')); ?>">
						<div class="sidebar_icon">
			...
			<li class="nav-links-li <?php echo e(request()->is('student/attendance*') || request()->is('student/routine*') || request()->is('student/subject*') || request()->is('student/syllabus*') ? 'showMenu':''); ?>">
				<div class="iocn-link">
					<a href="#">
						<div class="sidebar_icon">
            ...
            >
              ...
              />
				...
				<ul class="sub-menu">
					<li><a class="<?php echo e((request()->is('student/attendance*')) ? 'active' : ''); ?>" href="<?php echo e(route('student.daily_attendance')); ?>"><span><?php echo e(get_phrase('Daily Attendance')); ?></span></a></li>
					<li><a class="<?php echo e((request()->is('student/routine*')) ? 'active' : ''); ?>" href="<?php echo e(route('student.routine')); ?>"><span><?php echo e(get_phrase('Class Routine')); ?></span></a></li>
          <li><a class="<?php echo e((request()->is('student/subject*')) ? 'active' : ''); ?>" href="<?php echo e(route('student.subject_list')); ?>"><span><?php echo e(get_phrase('Subjects')); ?></span></a></li>
          <li><a class="<?php echo e((request()->is('student/syllabus*')) ? 'active' : ''); ?>" href="<?php echo e(route('student.syllabus')); ?>"><span><?php echo e(get_phrase('Syllabus')); ?></span></a></li>
				</ul>
			</li>

			<li class="nav-links-li <?php echo e(request()->is('student/marks') || request()->is('student/grade') ? 'showMenu':''); ?>">
          <div class="iocn-link">
              <a href="#">
                  <div class="sidebar_icon">
          ...
          <ul class="sub-menu">
              <li>
                  <a class="<?php echo e((request()->is('student/marks')) ? 'active' : ''); ?>" href="<?php echo e(route('student.marks')); ?>"><span><?php echo e(get_phrase('Marks')); ?></span></a>
              </li>
              <li>
                  <a class="<?php echo e((request()->is('student/grade')) ? 'active' : ''); ?>" href="<?php echo e(route('student.grade_list')); ?>"><span><?php echo e(get_phrase('Grades')); ?></span></a>
              </li>
          </ul>
      </li>
      ...
      <?php if(addon_status('online_courses')==1): ?>
        <li class="nav-links-li <?php echo e(request()->is('student/addons/courses*') ? 'showMenu':''); ?>">
            <div class="iocn-link">
                <a class="<?php echo e((request()->is('student/courses*')) ? 'active' : ''); ?>" href="<?php echo e(route('student.addons.courses')); ?>">
                    <div class="sidebar_icon">
      ...
      <li class="nav-links-li <?php echo e(request()->is('student/fee_manager*')  ? 'showMenu':''); ?>">
          <div class="iocn-link">
              <a class="<?php echo e((request()->is('student/fee_manager*')) ? 'active' : ''); ?>" href="<?php echo e(route('student.fee_manager.list')); ?>">
                  <div class="sidebar_icon">
        ...
        <div class="iocn-link">
            ...
            $notice_count = DB::table('noticeboard')
              ...
              <span class="notification" style="background-color: red;
                  border-radius: 50%; width: 18px; height: 18px; margin-top: 5px; margin-left: 5px; line-height: 20px;"><h5 style="font-size: 10px;  color: #fff; margin-top: -7px;display: flex; justify-content: center; "><?php echo e($notice_count); ?></h5></span>
              <?php else: ?>
              <span class="link_name"><?php echo e(get_phrase('Back Office')); ?></span>
              <?php endif; ?>
					</a>
              ...
              <div class="message">
                ...
                $last_message = DB::table('message_thrades')
                  ...
                  <?php if(!empty($last_message)): ?>
                    <a href="<?php echo e(route('student.message.all_message', ['id' => $last_message->id])); ?>" class="message_ico">
                  ...
                  <?php else: ?>
                    <a href="<?php echo e(route('student.message.chat_empty')); ?>" class="message_ico">
                        <svg class="w-6 h-6 text-gray-800 dark:text-white" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="currentColor" viewBox="0 0 24 24">
                            <path fill-rule="evenodd" d="M4 3a1 1 0 0 0-1 1v8a1 1 0 0 0 1 1h1v2a1 1 0 0 0 1.707.707L9.414 13H15a1 1 0 0 0 1-1V4a1 1 0 0 0-1-1H4Z" clip-rule="evenodd"/>
                            <path fill-rule="evenodd" d="M8.023 17.215c.033-.03.066-.062.098-.094L10.243 15H15a3 3 0 0 0 3-3V8h2a1 1 0 0 1 1 1v8a1 1 0 0 1-1 1h-1v2a1 1 0 0 1-1.707.707L14.586 18H9a1 1 0 0 1-.977-.785Z" clip-rule="evenodd"/>
                        </svg>
                  ...
                  <li class="user-profile">
                    <div class="btn-group">
                      ...
                      >
                        ...
                        <li>
                          <a class="dropdown-item" href="<?php echo e(route('student.password', ['edit'])); ?>">
                            <span>
        ...
        <div class="main_content">
            ...
            <div class="copyright-text">
              <?php $active_session = DB::table('sessions')->where('id',  get_settings('running_session'))->value('session_title'); ?>
                <p><?php echo e($active_session); ?> &copy; <span><a class="text-info footer-color" target="_blank" href="<?php echo e(get_settings('footer_link')); ?>"><?php echo e(get_settings('footer_text')); ?></a></span></p>
            </div>
            <!-- End Footer -->
        </div>
      </div>
...
<?php /**PATH /Applications/XAMPP/xamppfiles/htdocs/Ekattor8 School Management System/eq2/resources/views/student/navigation.blade.php ENDPATH**/ ?>