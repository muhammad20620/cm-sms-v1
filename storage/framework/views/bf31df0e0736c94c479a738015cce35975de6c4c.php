        ...
        <div class="form-row">
            ...
            <div class="fpb-7">
                ...
                <select name="package_type" id="package_type" class="form-select eForm-select eChoice-multiple-with-remove" >
                    ...
                    <option value="trial"><?php echo e(get_phrase('Trial')); ?></option>
            ...
            <div class="fpb-7">
                ...
                <select name="interval" id="interval" class="form-select eForm-select eChoice-multiple-with-remove" onchange="togglepackageWiseOptions(this.value)">
                    ...
                    <option id="life_time" value="life_time"><?php echo e(get_phrase('Life Time')); ?></option>
                </select>
            </div>
...
</script><?php /**PATH /Applications/XAMPP/xamppfiles/htdocs/Ekattor8 School Management System/eq2/resources/views/superadmin/package/add_package.blade.php ENDPATH**/ ?>