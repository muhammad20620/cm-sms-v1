<form method="POST" enctype="multipart/form-data" class="d-block ajaxForm" action="<?php echo e(route('admin.create.fee_manager', ['value' => 'single'])); ?>">
	...
	<div class="form-row">
		...
		<div class="fpb-7">
			<label for="amount" class="eForm-label"><?php echo e(get_phrase('Total amount').'('.school_currency().')'); ?></label>
...
</script><?php /**PATH /Applications/XAMPP/xamppfiles/htdocs/Ekattor8 School Management System/eq2/resources/views/admin/student_fee_manager/single.blade.php ENDPATH**/ ?>