        ...
        <div class="col-12">
            ...
            >
                <div class="d-flex flex-column">
                    <h4><?php echo e(get_phrase('Expired Subscription')); ?></h4>
                    <ul class="d-flex align-items-center eBreadcrumb-2">
                        <li><a href="#"><?php echo e(get_phrase('Home')); ?></a></li>
                        <li><a href="#"><?php echo e(get_phrase('Subscriptions')); ?></a></li>
                        <li><a href="#"><?php echo e(get_phrase('Expired Subscription')); ?></a></li>
                    </ul>
                </div>
            </div>
        </div>
    ...
    <div class="col-12">
        <div class="eSection-wrap">
        	<div class="search-filter-area d-flex justify-content-md-between justify-content-center align-items-center flex-wrap gr-15 pb-4">
                <form action="<?php echo e(route('superadmin.subscription.expired_subcription')); ?>">
                    <div
        	...
        	<div id="subscription_report">
	        	<div class="att-report-banner d-flex justify-content-center justify-content-md-between align-items-center flex-wrap">
		          <div class="att-report-summary order-1">
		            <h4 class="title"><?php echo e(get_phrase('Expired Subscription Report')); ?></h4>
...
<?php echo $__env->make('superadmin.navigation', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /Applications/XAMPP/xamppfiles/htdocs/Ekattor8 School Management System/eq2/resources/views/superadmin/subscription/expired_subcription.blade.php ENDPATH**/ ?>