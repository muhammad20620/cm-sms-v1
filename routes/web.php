...
use App\Http\Controllers\InstallControllerNew as InstallController;
...
Route::controller(AdminController::class)->middleware('admin','auth')->group(function () {
    ...
    //Appraisal
    Route::get('admin/appraisal-qustion', 'appraisalQustions')->name('admin.appraisal.appraisalQustions');
    Route::get('admin/appraisal-create-qustion', 'createQustion')->name('admin.appraisal.createQustion');
    Route::post('admin/appraisal-store-qustion', 'storeQustion')->name('admin.appraisal.storeQustion');
    Route::get('admin/appraisal-edit/{id}', 'appraisalQustionEdit')->name('admin.appraisal.appraisalQustionEdit');
    Route::post('admin/appraisal-qustion-update/{id}', 'appraisalQustionUpdate')->name('admin.appraisal.appraisalQustionUpdate');
    Route::get('admin/appraisal-qustion-delete/{id}', 'appraisalQustionDelete')->name('admin.appraisal.appraisalQustionDelete');
